...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
				...
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						<li><i class="fa fa-user"></i> <a href="index.jsp">ගෘහ
								මුලික තොරතුරු</a></li>
						<li class="active"><i class="fa fa-edit"></i>තොරතුරු වෙනස්
							කිරිම</li>
					</ol>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<!--                     <h2 class="page-header">ගෘහ මුලික තොරතුරු වෙනස් කිරිම </h2> -->
					<h2 style="color: #0664F0">ගෘහ මුලික තොරතුරු වෙනස් කිරිම</h2>
