...
function livingofcertificat(){
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					<h2 style="color: #0664F0">පදිංචි සහතික පත</h2>
					<!--                     
				...
				<div class="col-lg-8">
					...
					<div class="form-group" style="padding-top: 30px">
						<label for="inputEmail" class="control-label col-xs-5"
							...
							අංකය</label>
						<div class="col-xs-7">
							<input type="text" class="form-control" name="txtIdNo"
								id="txtIdNo">
						</div>
					</div>
										<div class="form-group" style="padding-top: 30px">
						<label for="inputEmail" class="control-label col-xs-5"
							style="font-size: 15px; text-align: left;">ඡන්ද හිමි නාම ලේඛන වර්ශය</label>
						<div class="col-xs-7">
					...
					<div class="form-group" style="padding-top: 30px;">
											<label for="inputEmail" class="control-label col-xs-5"
												style="font-size: 15px; text-align: left;">ලියාපදිංචි වී </label>
											<div class="col-xs-7">
												<label class="radio-inline" style="padding-right: 20px;">
													<input type="radio" name="livetrue" id="livetrue"
													value="ඇත" checked>ඇත
												</label> <label class="radio-inline"> <input type="radio"
													name="livetrue" id="livefalse" value="නැත">නැත
												</label>
											</div>
										</div>
																				...
																				<div class="form-group" style="padding-top: 30px">
											<label for="inputEmail" class="control-label col-xs-5"
												style="font-size: 15px; text-align: left;">ඉල්ලිම</label>
											<div class="col-xs-7">
												<select id="requeatfor" class="form-control" name="requeatfor">
													<option>-- තෝරන්න --</option>
													<option>ණය මුදලක් ලබා ගැනිම සදහා</option>
													<option>වීදුලිය ලබා ගැනිමී</option>
													<option>ජාතික හැදුනුම්පත නැතිවීම දැනුම්දිම සදහාී</option>
													<option>පහසු ගෙවීමෙ ක්‍රමයට වාහනයක් ගැනිමට</option>
													<option>කිසිවක් නොව</option>
												</select>
											</div>
										</div>
