    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
					...
					<div class="col-lg-12">
						...
						<ol class="breadcrumb" >
							<li><i class="fa fa-wrench"></i> <a href="index.jsp">සැකසුම් තොරතුරු</a>
							</li>
							<li class="active"><i class="fa fa-edit"></i>ග්‍රාම නිලධාරි තොරතුරු</li>
							<li class="active"><i class="fa fa-edit"></i>තොරතුරු සකස් කිරිම</li>
						</ol>
					</div>
				</div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h2 style="color: #0664F0">ග්‍රාම නිලධාරි තොරතුරු සකස් කිරිම</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
