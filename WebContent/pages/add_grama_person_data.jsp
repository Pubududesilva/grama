...
function savepersondata(){
	...
	var dataObj = {
			"txtGramaName" : $('#txtGramaName').val(),
			"txtIdNo" : $('#txtIdNo').val(),
			"txtTelephoneNo" : $('#txtTelephoneNo').val(),
	...
	$.ajax({
		type : "POST",
		url : "saveGramaPersonData",
		data : "gramadata=" + data1,
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					<h2 style="color: #0664F0">ග්‍රාම නිලධාරි තොරතුරු ගොනු කිරිම</h2>
					<!--                     
				...
				<div class="col-lg-8">
					<div class="form-group" style="padding-top: 30px">
						<label for="inputEmail" class="control-label col-xs-5"
							style="font-size: 15px; text-align: left;">ග්‍රාම නිලධාරි
							සම්පුර්න නම</label>
						<div class="col-xs-7">
							<input type="text" class="form-control" name="txtGramaName"
								id=""txtGramaName"">
						</div>
					</div>
					...
					<div class="form-group" style="padding-top: 30px">
						<label for="inputEmail" class="control-label col-xs-5"
							style="font-size: 15px; text-align: left;">පාර / පටුමග</label>
						<div class="col-xs-7">
							<textarea rows="6" class="col-xs-12" name="txtRoda" id="txtRoda"
								form="usrform">
</textarea>
						</div>
					</div>
